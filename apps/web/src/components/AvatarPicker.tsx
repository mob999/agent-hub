        ...
        {DEFAULT_AVATAR_PATHS.map((avatarPath) => {
          ...
          return (
            <button
              ...
              className={`relative h-[50px] w-[50px] appearance-none overflow-hidden rounded-xl border p-0.5 leading-none transition ${
                selected
      ...
      {previewAvatar && (
        ...
        >
          <img
            src={previewAvatar}
            alt="Avatar preview"
            className="h-72 w-72 max-h-[80vh] max-w-[80vw] rounded-2xl border-4 border-white object-cover"
          />
        </button>
      )}
    </div>
